...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'addemployee' || $page_name == 'employeelist' || $page_name == 'employee_salary_setup' || $page_name == 'leave_request_list' || $page_name == 'provident_fund_withdrawal'){echo 'active';}?>"> <a href="#"> <i class="fa fa-user" aria-hidden="true"></i> <span><?php echo $_data['menu_employee_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        ...
        <ul class="treeview-menu">
          ...
          <li class="<?php if($page_name != '' && $page_name == 'leave_request_list'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>employee/leave_request_list.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_employee_leave'];?></a>
          </li>
          <li class="<?php if($page_name != '' && $page_name == 'provident_fund_withdrawal'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>employee/provident_fund_withdrawal.php"><i class="fa fa-angle-double-right"></i>Provident Fund Withdrawal</a>
          </li>
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'expensesCategory' || $page_name == 'expenseHead' || $page_name == 'expenseAdd'){echo 'active';}?>"> <a href="#"> <i class="fa fa-dollar" aria-hidden="true"></i> <span><?php echo "Expenses" ?></span> <i class="fa fa-angle-left pull-right"></i> </a>

        <ul class="treeview-menu">

          <li class="<?php if($page_name != '' && $page_name == 'expensesCategory'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>expenses/expensesCategory.php"><i class="fa fa-angle-double-right"></i><?php echo "Expenses Category" ?></a></li>

          <li class="<?php if($page_name != '' && $page_name == 'expenseHead'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>expenses/expenseHead.php"><i class="fa fa-angle-double-right"></i><?php echo "Expenses Head" ?></a></li>

          <li class="<?php if($page_name != '' && $page_name == 'expenseAdd'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>expenses/expenseAdd.php"><i class="fa fa-angle-double-right"></i><?php echo "Add Expense" ?></a></li>

        </ul>

      </li>

      <li class="treeview <?php if($page_name != '' && $page_name == 'addNewBank' || $page_name == 'addNewBankTransaction'){echo 'active';}?>"> <a href="#"> <i class="fa fa-university"></i> <span><?php echo "Bank" ?></span> <i class="fa fa-angle-left pull-right"></i> </a>

        <ul class="treeview-menu">

          <li class="<?php if($page_name != '' && $page_name == 'addNewBank'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>bank/addNewBank.php"><i class="fa fa-angle-double-right"></i><?php echo "Add New Bank" ?></a></li>

          <li class="<?php if($page_name != '' && $page_name == 'addNewBankTransaction'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>bank/addNewBankTransaction.php"><i class="fa fa-angle-double-right"></i><?php echo "Bank Transaction" ?></a></li>

        </ul>

      </li>

      <li class="treeview <?php if($page_name != '' && $page_name == 'categories' || $page_name == 'products' || $page_name == 'inventory_types' || $page_name == 'inventory_locations' || $page_name == 'requisition' || $page_name == 'requisition_approval' || $page_name == 'purchase_good_received' || $page_name == 'purchase' || $page_name == 'suppliers'){echo 'active';}?>"> <a href="#"> <i class="fa fa-list" aria-hidden="true"></i> <span>Inventory</span> <i class="fa fa-angle-left pull-right"></i> </a>

        <ul class="treeview-menu">

          <li class="<?php if($page_name != '' && $page_name == 'requisition'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/requisition.php"><i class="fa fa-angle-double-right"></i><?php echo "Requisition" ?></a></li>

          <li class="<?php if($page_name != '' && $page_name == 'requisition_approval'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/requisition_approval.php"><i class="fa fa-angle-double-right"></i><?php echo "Requisition Approval" ?></a></li>
          
          <li class="<?php if($page_name != '' && $page_name == 'purchase'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/purchase.php"><i class="fa fa-angle-double-right"></i><?php echo "Purchase" ?></a></li>

          <!--<li class="<?php if($page_name != '' && $page_name == 'purchase_good_received'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/purchase_good_received.php"><i class="fa fa-angle-double-right"></i><?php echo "Purchase/Good Received" ?></a></li>-->

          <li class="<?php if($page_name != '' && $page_name == 'inventory_types'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/inventory_types.php"><i class="fa fa-angle-double-right"></i><?php echo "Inventory Type" ?></a></li>

          <li class="<?php if($page_name != '' && $page_name == 'inventory_locations'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/inventory_locations.php"><i class="fa fa-angle-double-right"></i><?php echo "Inventory Location" ?></a></li>

          <li class="<?php if($page_name != '' && $page_name == 'products'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/products.php"><i class="fa fa-angle-double-right"></i><?php echo "Products" ?></a></li>

          <li class="<?php if($page_name != '' && $page_name == 'categories'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/categories.php"><i class="fa fa-angle-double-right"></i><?php echo "Product Category" ?></a></li>
          
          <li class="<?php if($page_name != '' && $page_name == 'suppliers'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>inventory/suppliers.php"><i class="fa fa-angle-double-right"></i><?php echo "Supplier" ?></a></li>
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'add_maintenance_cost' || $page_name == 'maintenance_cost_list'){echo 'active';}?>"> <a href="#"> <i class="fa fa-cut"></i> <span>Bill Collection</span> <i class="fa fa-angle-left pull-right"></i> </a>

        <ul class="treeview-menu">

          <li class="<?php if($page_name != '' && $page_name == 'maintenance_cost_list'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>maintenance/maintenance_cost_list.php"><i class="fa fa-angle-double-right"></i>Bill Collection List</a></li>

          <li class="<?php if($page_name != '' && $page_name == 'add_maintenance_cost'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>maintenance/add_maintenance_cost.php"><i class="fa fa-angle-double-right"></i>Add Bill Collection</a></li>
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'fair_report' || $page_name == 'rented_report' || $page_name == 'visitors_report' || $page_name == 'complain_report' || $page_name == 'unit_report' || $page_name == 'fund_status' || $page_name == 'bill_report' || $page_name == 'salary_report' || $page_name == 'bill_collection_report'){echo 'active';}?>"> <a href="#"> <i class="fa fa-bar-chart-o"></i> <span><?php echo $_data['menu_report'];?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        ...
        <ul class="treeview-menu">
          ...
          <li class="<?php if($page_name != '' && $page_name == 'bill_collection_report'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>report/bill_collection_report.php"><i class="fa fa-angle-double-right"></i>Bill Collection Report</a></li>
          
          <li class="<?php if($page_name != '' && $page_name == 'monthly_expense_deposite_report'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>report/monthly_expense_deposite_report.php"><i class="fa fa-angle-double-right"></i>Monthly Report</a></li>
	  ...
	  <li class="treeview <?php if($page_name != '' && $page_name == 'bill_setup' || $page_name != '' && $page_name == 'utility_bill_setup' || $page_name == 'member_type_setup' || $page_name == 'month_setup' || $page_name == 'year_setup' || $page_name == 'language' || $page_name == 'admin' || $page_name == 'add_building_info' || $page_name == 'branchlist' || $page_name == 'addbranch' || $page_name == 'currency_setup' || $page_name == 'language_setup'){echo 'active';}?>"> <a href="#"> <i class="fa fa-wrench"></i> <span><?php echo $_data['menu_settings'];?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        ...
        <ul class="treeview-menu">
          ...
          <li class="<?php if($page_name != '' && $page_name == 'bill_title_setup'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/bill_title_setup.php"><i class="fa fa-angle-double-right"></i>Maintanance Bill Setup</a></li>

...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo WEB_URL?>report/bill_collection_report.php"><?php echo $_data['text_2'];?></a></li>
  ...
  <div class="col-md-12">
    ...
    <div class="box box-success">
      ...
      <div class="box-header">
        ...
        <h3 class="box-title">Bill Collection Report Form</h3>
        ...
        <div class="box-footer">
          ...
          <div class="form-group pull-right">
            ...
            <input type="button" onclick="billCollection()" value="<?php echo $_data['text_7'];?>" class="btn btn-success"/>
...
<script type="text/javascript">
	...
	function billCollection(){
		...
		if(floor_id == '' && unit_id == '' && month_id == '' && year_id == ''){
			...
			window.open('<?php echo WEB_URL;?>report/bill_collection_info_floor.php?fid=' + floor_id + '&uid=' + unit_id + '&mid=' + month_id + '&yid=' + year_id);

...
if(isset($_POST['ddlEmpName'])){
		...
		$sqlProvidentFund="INSERT INTO `tbl_total_provident_fund`(`e_id`,`total_provident_fund`,`withdrawal_fund`,`withdrawal_date`,`approved_by_id`) VALUES ('$_POST[eidid]','$_POST[e_provident_fund]',0,0,0)";
